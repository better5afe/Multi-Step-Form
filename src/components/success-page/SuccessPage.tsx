	...
	return (
		<form className='form pb-16 text-center'>
			<div className='form__input flex flex-col justify-center items-center'>
				<svg
					className='w-[80px] h-[80px] mb-3 large:w-[130px] large:h-[130px]'
				...
				<StepTitle
					stepTitle='Thank you!'
					stepDesc='Thanks for confirming your subscription!'
					addDesc='We hope you have fun using our platform. If you ever need support, please feel free to email us at support@loregaming.com'
				/>
			</div>
		</form>
	);
